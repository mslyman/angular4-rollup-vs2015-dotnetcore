...
AppModule = __decorate([
    core_1.NgModule({
        imports: [platform_browser_1.BrowserModule, forms_1.FormsModule, http_2.HttpClientModule],
        declarations: [app_component_1.AppComponent, races_component_1.RacesComponent],
        bootstrap: [app_component_1.AppComponent],
        providers: [race_service_1.RaceService, log_service_1.LogService, http_1.Http]
    })
], AppModule);
